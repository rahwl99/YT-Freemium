(function () {
    ...
    const domainsToRemove = [
        '*.youtube-nocookie.com', // Removed the wildcard and trailing slash
    ];
    ...
    if (debug) console.log('Youtube Freemium: Script started');
    ...
    function popupRemover() {
        ...
        setInterval(() => {
            ...
            if (popup) {
                if (debug) console.log('Youtube Freemium: Popup detected, removing...');
                ...
                if (debug) console.log('Youtube Freemium: Popup removed');
            }
    ...
    function unPauseVideo() {
        ...
        unpausedAfterSkip = 0;
        if (debug) console.log('AdBlock: Unpaused video using "k" key');
    }
